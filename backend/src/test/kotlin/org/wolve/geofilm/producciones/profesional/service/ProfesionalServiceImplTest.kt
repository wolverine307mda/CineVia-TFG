...
class ProfesionalServiceTest {
 ...
 @Test
 fun `getProfesionalById - existing id returns response`() {
  val id = "prof1"
 ...
 @Test
 fun `getProfesionalById - missing id returns null`() {
  val id = "missing"
 ...
 @Test
 fun `createProfesional - maps, saves and returns response`() {
 ...
 @Test
 fun `updateProfesional - existing id updates and returns response`() {
  val id = "prof3"
  val request = ProfesionalRequest(
   nombre = "Upd",
   foto = "upd.png",
 ...
 @Test
 fun `updateProfesional - missing id returns null`() {
  val id = "none"
  val request = ProfesionalRequest(
   nombre = "X",
   foto = "x.png",
 ...
 @Test
 fun `deleteProfesional - existing id deletes entity`() {
  val id = "prof4"
 ...
 @Test
 fun `filtrarProfesionales - returns paginated response`() {
  val page = 0
  val size = 3
 ...
 @Test
 fun `getAllProfesionales returns paginated list`() {
 ...
 @Test
 fun `actualizarImagen - existing id updates foto and returns response`() {
  val id = "prof6"
  ...
  verify(profesionalRepository).save(profesional)
    ...
    @Test
    fun `searchByNombre - returns paginated response`() {
        val page = 0
        val size = 2
     val pageable = PaginationUtils.createPageable(
      page = page,
 ...
 @Test
 fun `findEntityById - returns entity if exists`() {
  val id = "prof8"
  val entity = Profesional(
   id = id,
   nombre = "Nombre",
 ...
 @Test
 fun `findEntityById - returns null if not found`() {
  val id = "notfound"
  whenever(profesionalRepository.findById(id)).thenReturn(Optional.empty())
 ...
 @Test
 fun `filtrarProfesionales - throws exception on invalid date format`() {
